...
function load_data(out, name)
    ...
    CSV.write("/Users/mathewjacob/Desktop/RxCOVea/COVID-19/SpatialModel/MonteCarlo/Results/NoRestrictions2/"*name*".csv", df)
    return df
end
...
CSV.write("/Users/mathewjacob/Desktop/RxCOVea/COVID-19/SpatialModel/MonteCarlo/Results/NoRestrictions2/total_infected.csv", total_infected)
